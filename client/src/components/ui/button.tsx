...
const buttonVariants = cva(
  ...
  " hover-elevate active-elevate-2",
  {
    variants: {
      ...
      size: {
        default: "min-h-[44px] lg:min-h-9 px-4 py-2",
        sm: "min-h-[44px] lg:min-h-8 rounded-md px-3 text-xs",
        lg: "min-h-[44px] lg:min-h-10 rounded-md px-8",
        icon: "h-[44px] w-[44px] lg:h-9 lg:w-9",
      },
    },
    defaultVariants: {
      variant: "default",
